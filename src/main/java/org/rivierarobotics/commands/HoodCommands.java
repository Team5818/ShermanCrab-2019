...
public class HoodCommands {
    ...
    private final HoodEncoderResetCreator hoodEncoderResetCreator;

    @Inject
    public HoodCommands(HoodSetPositionCreator hoodSetPositionCreator, HoodEncoderResetCreator hoodEncoderResetCreator) {
